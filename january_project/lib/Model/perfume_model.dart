...
List<PerfumeModel> perfumesList = [
  PerfumeModel(
    ...
    price: 165,
    isFav: false,
    description: '''ABOUT THE FRAGRANCE:L’Instant de Guerlain pour Homme highlights a unique moment: the one in which a man takes the initiative and after which everything will be different.This woody, sparkling, seductive fragrance was composed of contrasts. It is nothing less than surprising.''',
  ),
  ...
  PerfumeModel(
    ...
    price: 137,
    isFav: false,
    description: '''Launch year: 2020. Top notes:Bergamot, Italian mandarin, Geranium. Heart notes: Grasse rose, Damask rose. Base notes: White musks.Design house: Christian Dior. Scent name: Miss Dior Rose N'roses.''',
  ),
  ...
  PerfumeModel(
    ...
    price: 184,
    isFav: false,
    description: '''Rose, White Musks, Wood of Almond L'Instant Magic transports you to a dream world.With its immediately identifiable scent, it illustrates the instant when a dream suddenly becomes possible.L’Instant Magic is a light, soft fragrance, a mist that caresses on a bed of wood and musk.''',
  ),
];
